                                ...
                                <div class="user-data full-width">
                                    <div class="user-profile">
                                        <div class="username-dt">
                                            <div class="usr-pic">
                                                <img src="/workwise/images/resources/user-pic.png" alt>
                                            </div>
                                        </div>
                                ...
                                <div class="posts-section">
                                    <div class="post-bar">
                                        <div class="post_topbar">
                                            <div class="usy-dt">
                                                ...
                                                <div class="usy-name">
                                                    <h3>John Doe</h3>
                                                    <span><img src="/workwise/images/clock.png" alt>3 min
                                                        ago</span>
                                                </div>
                                            </div>
                                            <div class="ed-opts">
                                        ...
                                        <div class="epi-sec">
                                            <ul class="descp">
                                                <li><img src="/workwise/images/icon8.png" alt><span>Epic
                                                        Coder</span></li>
                                                <li><img src="/workwise/images/icon9.png" alt><span>India</span>
                                                </li>
                                            </ul>
                                            <ul class="bk-links">
                                    ...
                                    <div class="top-profiles">
                                        ...
                                        <div class="profiles-slider">
                                            <div class="user-profy">
                                                <img src="/workwise/images/resources/user1.png" alt>
                                                <h3>John Doe</h3>
                                                <span>Graphic Designer</span>
                                                <ul>
                                                    <li><a href="#" title class="followw">Follow</a></li>
                                                    <li><a href="#" title class="envlp"><img
                                                                src="/workwise/images/envelop.png" alt></a></li>
                                            ...
                                            <div class="user-profy">
                                                <img src="/workwise/images/resources/user3.png" alt>
                                                <h3>John Doe</h3>
                                                <span>Graphic Designer</span>
                                                <ul>
                                                    <li><a href="#" title class="followw">Follow</a></li>
                                            ...
                                            <div class="user-profy">
                                                <img src="/workwise/images/resources/user2.png" alt>
                                                <h3>John Doe</h3>
                                                <span>Graphic Designer</span>
                                                <ul>
                                                    <li><a href="#" title class="followw">Follow</a></li>
                                    ...
                                    <div class="posty">
                                        <div class="post-bar no-margin">
                                            <div class="post_topbar">
                                                <div class="usy-dt">
                                                    <img src="/workwise/images/resources/us-pc2.png" alt>
                                                    <div class="usy-name">
                                                        <h3>John Doe</h3>
                                        ...
                                        <div class="comment-section">
                                                ...
                                                <ul>
                                                    <li>
                                                        <div class="comment-list">
                                                            <div class="bg-img">
                                                                <img src="/workwise/images/resources/bg-img1.png" alt>
                                                            </div>
                                                            <div class="comment">
                                                                <h3>John Doe</h3>
                                                                <span><img src="/workwise/images/clock.png" alt> 3
                                                                    min
                                                                    ago</span>
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <div class="comment-list">
                                                                    <div class="bg-img">
                                                                        <img src="/workwise/images/resources/bg-img2.png"
                                                                            alt>
                                                                    </div>
                                                                    <div class="comment">
                                                                        <h3>John Doe</h3>
                                                    ...
                                                    <li>
                                                        <div class="comment-list">
                                                            <div class="bg-img">
                                                                <img src="/workwise/images/resources/bg-img3.png" alt>
                                                            </div>
                                                            <div class="comment">
                                                                <h3>John Doe</h3>
                                                                <span><img src="/workwise/images/clock.png" alt> 3
                                            ...
                                            <div class="post-comment">
                                                <div class="cm_img">
                                                    <img src="/workwise/images/resources/bg-img4.png" alt>
                                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <ul>
                                ...
                                <li><a href="#" title class="cancel-post-project">Cancel</a></li>
                            </ul>
                        </div>
                    </div>
                </form>
