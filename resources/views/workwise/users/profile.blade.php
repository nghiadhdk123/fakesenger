...
<section class="cover-sec">
    <img src="/workwise/images/resources/cover-img.jpg" alt>
    <div class="add-pic-box">
        <div class="container">
            <div class="row no-gutters">
                <div class="col-lg-12 col-sm-12">
                    <input type="file" id="file">
                    <label for="file">Chỉnh sửa ảnh bìa</label>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="main-left-sidebar">
                            <div class="user_profile">
                                <div class="user-pro-img">
                                    <img src="/workwise/images/resources/user-pro-img.png" alt>
                        ...
                        <div class="main-ws-sec">
                            ...
                            <div class="product-feed-tab current" id="feed-dd">
                                <div class="posts-section">
                                    ...
                                    <div class="post-bar">
                                        ...
                                        <div class="epi-sec">
                                            <ul class="descp">
                                                <li><img src="/workwise/images/icon8.png" alt><span>Front End
                                                        Developer</span></li>
                                                <li><img src="/workwise/images/icon9.png" alt><span>India</span></li>
                                            </ul>
                                            <ul class="bk-links">
                            ...
                            <div class="product-feed-tab" id="my-bids">
                                <div class="posts-section">
                                    <div class="post-bar">
                                        ...
                                        <div class="job-status-bar">
                                            <ul class="like-com">
                                                ...
                                                <li><a href="#" title class="com"><img src="/workwise/images/com.png" alt>
                                                        Comment 15</a></li>
                                            </ul>
                                    ...
                                    <div class="process-comm">
                                        <a href="#" title><img src="/workwise/images/process-icon.png" alt></a>
                                    </div>
                                </div>
                            </div>
